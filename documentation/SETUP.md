...
Guide for setting up and running the Triplyy monorepo locally.
...
1. **Auth docs**: See [AUTH.md](./AUTH.md)
2. **API docs**: Visit `http://localhost:3000/docs`
3. **Run the web app**: Visit `http://localhost:3001`
