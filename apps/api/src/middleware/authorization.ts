 ...
 * ## Role-based access
 *
 * Triplyy uses subscription entitlements for gating features; role-based access is not used.
 */
 ...
 */
// NOTE: role-based access removed; use subscription tier checks in handlers instead.
