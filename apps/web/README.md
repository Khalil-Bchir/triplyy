...
The Triplyy web app contains the public landing page and the authenticated dashboard experience.
...
## Notes
- Authentication and session behavior are documented in `[documentation/AUTH.md](../../documentation/AUTH.md)`.
